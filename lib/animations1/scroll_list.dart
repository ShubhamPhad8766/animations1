import 'package:demo/animations1/scroll_list_model.dart';
import 'package:flutter/material.dart';

class ScrollListScreen extends StatefulWidget {
  const ScrollListScreen({super.key});

  @override
  State<ScrollListScreen> createState() => _ScrollListScreenState();
}

class _ScrollListScreenState extends State<ScrollListScreen> {
                      ...
                      children: [
                        ...
                        SingleChildScrollView(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                discoveritem(size, Colors.orange,
                                    "Most Favorite", "20 Items"),
                                discoveritem(
                                    size, Colors.blue, "Newest", "20 Items"),
                                discoveritem(size, Colors.blueAccent,
  ...
  Container discoveritem(Size size, Color color, name, items) {
    return Container(
